...
class Contact extends Component {
    constructor(props) {
        super(props);
        this.handleSubmit= this.handleSubmit.bind(this);//important function otherwise we won't be able to use props inside the function.
    }
            ...
            <div className="row row-content">
                ...
                <div className="col-12 col-sm-11 offset-sm-1">
                    <div className="btn-group" role="group">
                        ...
                        <a role="button" className="btn btn-info" href="http:confusion@food.net"><i className="fa fa-skype"></i> Skype</a>
